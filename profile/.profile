...
alias node-info="cd ~/ceremonyclient/node && ./node-2.0.4-linux-amd64 -node-info && cd ~"
alias db-console="cd ~/ceremonyclient/node && ./node-2.0.4-linux-amd64 --db-console && cd ~"
alias balance="cd ~/ceremonyclient/node && ./node-2.0.4-linux-amd64 -balance && cd ~"
...
alias qbalance="cd ~/ceremonyclient/node && ./qclient-2.0.4-linux-amd64 token balance"
alias qtoken="cd ~/ceremonyclient/node && ./qclient-2.0.4-linux-amd64 token coins"
alias qmint="cd ~/ceremonyclient/node && ./qclient-2.0.4-linux-amd64 token mint all"
