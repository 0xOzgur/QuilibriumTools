...
alias node-info="cd ~/ceremonyclient/node && ./node-2.0.2.3-linux-amd64 -node-info && cd ~"
alias db-console="cd ~/ceremonyclient/node && ./node-2.0.2.3-linux-amd64 --db-console && cd ~"
alias balance="cd ~/ceremonyclient/node && ./node-2.0.2.3-linux-amd64 -balance && cd ~"
